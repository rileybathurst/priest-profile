      ...
      <div id="header-contact-background" class="shadow">
        <div class="header-contact">
          ...
          <section class="together">
            ...
            </div>{/* summit__contact--phone */}

            <div className="summit__contact--service summit__contact--email">
              <a
                href="https://goo.gl/maps/EzF5epUkFxaEihtLA"
                className="summit__contact--icon"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
              ...
              <a
                href="https://goo.gl/maps/EzF5epUkFxaEihtLA"
                className="summit__contact--text"
              >
